        ...
        <tr>
            ...
            <div id="select2">
                <select name="players" multiple><option value="" selected disabled>Please select your favorite player(s)...</option>
                  ...
                  <option value="kane">Harry Kane</option>
                  <option value="lahm">Philip Lahm</option>
                  <option value="torres">Fernando Torres</option>
                  <option value="hazard">Eden Hazard</option>
                  <option value="dybala">Paulo Dybala</option>
                  <option value="costa">Diego Costa</option>
