            ...
            <tr>
                <td>
                    <div class="song">
                        ...
                        &nbsp;&nbsp;
                        <button class="playBtn" title="Play"><i class="fa fa-play"></i></button>
                        &nbsp;&nbsp;<p>Ryan Gosling: From "La La Land"</p>
                        <audio class="audioPlayHide" controls>
            ...
            <tr>
                <td>
                    <div class="song">
                        ...
                        &nbsp;&nbsp;
                        <button class="playBtn" title="Play"><i class="fa fa-play"></i></button>
                        &nbsp;&nbsp;<p>The Chainsmokers: Something Just Like You</p>
                        <audio class="audioPlayHide" controls>
            ...
            <tr>
                <td>
                    <div class="song">
                        ...
                        &nbsp;&nbsp;
                        <button class="playBtn" title="Play"><i class="fa fa-play"></i></button>
                        &nbsp;&nbsp;<p>ThunderCat: Captain Stupido</p>
                        <audio class="audioPlayHide" controls>
