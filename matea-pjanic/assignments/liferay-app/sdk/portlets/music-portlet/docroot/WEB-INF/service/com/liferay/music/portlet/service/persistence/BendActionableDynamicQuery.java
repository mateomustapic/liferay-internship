 ...
 * @generated
 */
public abstract class BendActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BendActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BendLocalServiceUtil.getService());
		setClass(Bend.class);

		setClassLoader(com.liferay.music.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("bendId");
	}
}