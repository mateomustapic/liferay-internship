...
import com.liferay.music.portlet.NoSuchEventException;
import com.liferay.music.portlet.model.Event;
import com.liferay.music.portlet.model.impl.EventImpl;
import com.liferay.music.portlet.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	@Override
	public Event updateImpl(com.liferay.music.portlet.model.Event event)
	...
	protected Event toUnwrappedModel(Event event) {
		...
		eventImpl.setArtist(event.getArtist());
		eventImpl.setCity(event.getCity());
		eventImpl.setCountry(event.getCountry());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.music.portlet.model.Event")));
