...
/**
 * Provides the local service interface for Bend. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matea Pjanic
 * @see BendLocalServiceUtil
...
public interface BendLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BendLocalServiceUtil} to access the bend local service. Add custom service methods to {@link com.liferay.music.portlet.service.impl.BendLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
