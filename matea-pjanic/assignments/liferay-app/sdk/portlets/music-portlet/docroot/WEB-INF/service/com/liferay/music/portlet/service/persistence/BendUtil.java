...
/**
 * The persistence utility for the bend service. This utility wraps {@link BendPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BendUtil {
	 ...
	 */
	public static void clearCache(Bend bend) {
		getPersistence().clearCache(bend);
	}
	 ...
	 */
	public static List<Bend> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static Bend update(Bend bend) throws SystemException {
		return getPersistence().update(bend);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static Bend update(Bend bend, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(bend, serviceContext);
	}
	...
	*/
	public static com.liferay.music.portlet.model.Bend findByName(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.music.portlet.model.Bend fetchByName(
		java.lang.String name)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.music.portlet.model.Bend removeByName(
		java.lang.String name)
		throws com.liferay.music.portlet.NoSuchBendException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @param bend the bend
	*/
	public static void cacheResult(com.liferay.music.portlet.model.Bend bend) {
		getPersistence().cacheResult(bend);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(bends);
	}
	...
	* @return the new bend
	*/
	public static com.liferay.music.portlet.model.Bend create(long bendId) {
		return getPersistence().create(bendId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.music.portlet.model.Bend remove(long bendId)
		throws com.liferay.music.portlet.NoSuchBendException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(bendId);
	}

	public static com.liferay.music.portlet.model.Bend updateImpl(
		com.liferay.music.portlet.model.Bend bend)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(bend);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.music.portlet.model.Bend findByPrimaryKey(
		long bendId)
		throws com.liferay.music.portlet.NoSuchBendException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(bendId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.music.portlet.model.Bend fetchByPrimaryKey(
		long bendId) throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(bendId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.music.portlet.model.Bend> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BendPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BendPersistence)PortletBeanLocatorUtil.locate(com.liferay.music.portlet.service.ClpSerializer.getServletContextName(),
					BendPersistence.class.getName());

			ReferenceRegistry.registerReference(BendUtil.class, "_persistence");
		}
	 ...
	 */
	public void setPersistence(BendPersistence persistence) {
	}

	private static BendPersistence _persistence;
}